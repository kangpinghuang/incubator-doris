...
void print_usage(std::string progname) {
    ...
    std::cout << "./meta_tool --operation=get_meta --root_path=/path/to/storage/path --tablet_id=tabletid --schema_hash=schemahash" << std::endl;
    std::cout << "./meta_tool --operation=load_meta --root_path=/path/to/storage/path --json_meta_path=path" << std::endl;
    std::cout << "./meta_tool --operation=delete_meta --root_path=/path/to/storage/path --tablet_id=tabletid --schema_hash=schemahash" << std::endl;
    std::cout << "./meta_tool --operation=show_meta --pb_meta_path=path" << std::endl;
}
